...
<div class="container-fluid"> @include('user.layouts.notification') 
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Dashboard</h1>referral code: http://localhost/spdapt/referralcode?rc={{auth()->user()->phone_no}}
    </div>
      ...
      <div class="col-xl-4 col-md-6 mb-4">
        <div class="card border-left-success shadow h-100 py-2">
          <div class="card-body">
            <div class="row no-gutters align-items-center">
              <div class="col mr-2">
                <div class="text-xs font-weight-bold text-success text-uppercase mb-1">REFERRAL NUMBER</div> <!-- https://spdatp.online/referralcode?rc= -->
                <div class="h5 mb-0 font-weight-bold text-gray-800">{{ auth()->user()->phone_no }}</div>
              </div>
              <div class="col-auto">
