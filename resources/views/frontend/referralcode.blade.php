...
<section class="returns-sec all-common-login">
    ...
    <div class="returns-form">
        ...
        <form class="form" method="post" action="{{route('register.referralcode')}}">
            @csrf
            <div class="billing-details-form">
                ...
                <div class="form-group full-width-f-g">
                    ...
                    <input type="number" name="phone_no" placeholder="" required="required" class="form-control" value="{{old('phone_no')}}">
                    @error('phone_no') <span class="text-danger">{{$message}}</span> @enderror </div>
                <div class="form-group full-width-f-g">
                    <label>Referral Code</label>
                    <input type="text" class="form-control" name="referralcode" value="{{$referralcode}}" readonly>
