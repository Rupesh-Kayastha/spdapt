            ...
            <form method="post" action="{{ route('product.store') }}" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-xl-6 col-md-6 mb-4">
                        ...
                        <input id="inputTitle" type="text" name="lock_days" placeholder="Enter lock day" value="{{ old('lock_days') }}" class="form-control">
                        @error('lock_days')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-6 col-md-6 mb-4">
                        ...
                        <input id="inputTitle" type="text" name="owner" placeholder="Enter owner" value="{{ old('owner') }}" class="form-control">
                        @error('owner')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>
