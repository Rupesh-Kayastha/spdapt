...
@section('main-content')
    <div class="card">
        <h5 class="card-header">Edit Product <a style="float:right;" target="_blank"
                href="{{ url('/') }}/shop/{{ $product->slug }}">Visit Product Page<i class="fas fa-link"
                    style="width:20px"></i></a></h5>
        <div class="card-body">
                ...
                <div class="row">
                    <div class="col-xl-6 col-md-6 mb-4">
                        <label for="inputPhoto" class="col-form-label">Photo <span class="text-danger">*</span><br>
                            <em class="text-danger">For multiple image upload choose image & press ctrl key for multiselect.</em>
                        </label>
                        <input id="inputPhoto" class="form-control" type="file" name="photo[]" multiple accept="image/png, image/gif, image/jpeg">
                        <div id="holder" style="margin-top:15px;max-height:100px;"></div>
                        
                        <img src="{{ asset("storage/product/") . "/" . $product->filename }}" alt="Product Photo" style="max-width: 100px; margin-right: 10px;">
