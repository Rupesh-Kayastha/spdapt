            ...
            <tbody>
              ...
              @foreach ($categories as $category)
                ...
                <tr>
                  ...
                  <td>
                  <a target="_blank" href="{{url('/')}}/product-category/{{ $category->slug}}" class="btn btn-primary btn-sm float-left mr-1"
                      style="height:30px; width:30px;border-radius:50%" data-toggle="tooltip" title="view"
                      data-placement="bottom"><i class="fas fa-eye"></i></a>

                    <a href="{{ route('category.edit', $category->id) }}" class="btn btn-primary btn-sm float-left mr-1"
